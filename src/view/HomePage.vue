      ...
      customerList: [
        {
          ...
          title:
            "本项目通过微信小程序的形式为家庭用户提供“保洁”，“家电维修”等家庭服务获取入口，方便家庭用户在线购买。",
          content:
            "将“保洁阿姨”和“家电维修师傅”等人力资源上架至微信小程序，通过算法实现人力资源商品与客户订单的高效匹配，为家庭服务公司完成人力资源和客户评价的最大化。"
        },
        {
          logo: require("@/assets/img/logo_kk.png"),
          title:
            "通过物联网技术完成配电房电力数据采集，并上传至云平台进行数据存储，监控预警和大数据分析。",
          content:
            "服务于各行用电单位，提供用电安全保障的同时，尽可能实现能耗优化。并在此基础上提供实时电力维保，巡检和远程抄表等增值服务。同时为企业客户提供PC端和移动端APP入口。"
        },
        {
          logo: require("@/assets/img/logo_toyota.png"),
          title:
            "维保APP是一款为电气服务从业的人员、团队，提供源源不断的售后项目订单APP。",
          content:
            "入驻安极能维保的工程师可在平台进行抢单来提高自己的收入。单位出现检修、巡检等需求，即可在后台下单，也可直接派单，电工根据订单需求，完成后提交检修单或巡检单到需求方审核。"
        },
        {
          logo: require("@/assets/img/logo_kk.png"),
          title:
...
.swiper-button-next {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z'%20fill%3D'%232288ff'%2F%3E%3C%2Fsvg%3E")  !important;
